...
function init(){
	...
	if( lsScore !== null ){
		//Bug 4 score printing additional 5 because of  string, using Number method to convert score to number data type
...
function setupSquares(){
	...
	//add click listeners to squares
		squares[i].addEventListener("click", function(){
			...
			//BUG1 originally showed = assignment not strict equality check resulting in first choice being shown as correct every time
